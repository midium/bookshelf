...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		draw: function(ease) {
			...
			helpers.each(me.getDataset(),function(dataset,datasetIndex){
					helpers.each(dataset.bars,function(bar,index){
							if (bar.hasValue()){
									bar.base = this.scale.endPoint;
									//Transition then draw
									bar.transition({
											x : this.scale.calculateBarX(me.getDataset().length, datasetIndex, index),
											y : this.scale.calculateY(bar.value),
											width : this.scale.calculateBarWidth(me.getDataset().length)
									}, easingDecimal).draw();
							}
					},this);
