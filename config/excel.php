...
return array(
    ...
    'properties' => array(
        'creator'        => 'MiDiUm Bookshelf',
        'lastModifiedBy' => 'MiDiUm Bookshelf',
        'title'          => 'MiDiUm Bookshelf - Full Shelf',
        'description'    => 'This is an exportation of all the books in the shelf with all the available informations',
        'subject'        => 'MiDiUm Bookshelf',
        'keywords'       => 'bookshelf, excel',
        'category'       => 'Excel',
        'manager'        => 'Matteo Loro (matteo.loro@gmail.com)',
        'company'        => 'MiDiUm Software © 1998-'.date('Y'),
    ),
